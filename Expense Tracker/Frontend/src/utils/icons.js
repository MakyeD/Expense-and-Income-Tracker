...
export const plumbing = <i className="fa-solid fa-wrench"></i>
...
export const soap = <i className="fa-solid fa-soap"></i>
...
export const bowl = <i className="fa-solid fa-bowl-food"></i>
export const paw = <i className="fa-solid fa-paw"></i>
export const circle = <i className="fa-solid fa-circle"></i>
export const gamepad = <i className = "fa-solid fa-gamepad"></i>